          ...
          <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
            <div className="text-center mb-24">
              ...
              <p className="text-xl lg:text-2xl text-slate-600 max-w-4xl mx-auto leading-relaxed font-light">
                From entrepreneurship to international trade, we develop strategic thinkers and innovative leaders 
                who shape the future of global business and economic development.
              </p>
            </div>
              ...
              <div className="lg:col-span-2">
                <Card className="border-0 bg-white shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 rounded-3xl overflow-hidden">
                  ...
                  <CardContent className="space-y-6">
                    ...
                    <p className="text-slate-600 leading-relaxed text-lg">
                      We emphasize experiential learning, industry partnerships, and cutting-edge research in areas such as business 
                      economics, international trade, and applied linguistics. Our faculty members are experienced professionals and 
              ...
              <Card className="border-0 bg-white shadow-2xl rounded-3xl max-w-5xl mx-auto overflow-hidden">
                ...
                <CardContent className="p-16">
                  ...
                  <p className="text-xl text-slate-600 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
                    Join our community of business leaders and innovators. Discover which program aligns with your 
                    career goals and start building your future in the dynamic world of business.
                  </p>
