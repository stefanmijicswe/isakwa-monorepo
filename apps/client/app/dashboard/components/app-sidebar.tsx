                ...
                <div className="bg-sidebar-accent/50 rounded-xl p-4">
                  ...
                  <div className="flex gap-2">
                    <button 
                      ...
                      className="flex-1 px-3 py-2 text-xs font-medium text-sidebar-foreground/70 hover:text-sidebar-foreground hover:bg-sidebar-accent rounded-lg transition-colors flex items-center justify-center gap-2"
                    >
